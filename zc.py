...
def ranstr(num):
    ...
    return salt
#salt = ranstr(8)
salt = "骗子站必须打_" + ranstr(6)
#salt = "i0PGS7TR"
em = "@gmail.com"

redata={
    'content':'你马勒戈壁又弄个垃圾站出来骗钱！这垃圾骗子站，充会员的都是傻子！你马勒戈壁又弄个垃圾站出来骗钱！这垃圾骗子站，充会员的都是傻子！你马勒戈壁又弄个垃圾站出来骗钱！这垃圾骗子站，充会员的都是傻子！你马勒戈壁又弄个垃圾站出来骗钱！这垃圾骗子站，充会员的都是傻子！你马勒戈壁又弄个垃圾站出来骗钱！这垃圾骗子站，充会员的都是傻子！',
    'author': (salt),
    'mail':'http://nimalagebibi.caonima'
}
# 注册变量
#访问注册页面
r0=requests.get('https://www.laikaym.com/sq/',headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36'}, )
cookies=r0.cookies.get_dict()

# 注册账号
r1=requests.post('https://www.laikaym.com/sq/app/class/ajax.php?act=add&id=0',data=redata,headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36'},cookies=cookies)
print(redata)

# 登录账号
##r2=requests.post('https://panel.kitbaby.tk/auth/login',data={'email':(salt+em),'passwd':(salt)},headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36'},cookies=cookies)
...
##session = HTMLSession()
##url="https://panel.kitbaby.tk/user"
